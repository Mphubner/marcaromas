...
export default function PlanEditPage() {
  ...
  // Popular formulário quando plano for carregado
  useEffect(() => {
    if (plan) {
      setFormData({
        name: plan.name || "",
        ...
        items_included: plan.items_included || [],
  ...
  const updatePlanMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries(["admin-plan", id]);
    ...
    return (
      <div className="p-8 flex items-center justify-center min-h-[60vh]">
        <div className="text-center space-y-3">
          ...
          <Button onClick={() => navigate("/admin/plans")} className="rounded-lg">
            Voltar para Planos
          </Button>
        </div>
      </div>
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-[#2C2419]">Editar Plano: {plan.name}</h1>
