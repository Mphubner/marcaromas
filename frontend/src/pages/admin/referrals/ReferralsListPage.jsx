...
import { Search, Filter, Users, TrendingUp, DollarSign, Copy, CheckCircle, Edit2 } from 'lucide-react';
...
export default function ReferralsListPage() {
  ...
  const getStatusBadge = (status) => {
    ...
    return <Badge className={`${color} rounded-lg`}>{label}</Badge>;
  };
  ...
  return (
    <div className="p-8 space-y-6">
      {/* Header */}
      <div>
        <h2 className="text-3xl font-bold text-gray-900">Indicações</h2>
        <p className="text-gray-500 mt-1">Gerencie indicações e recompensas</p>
      </div>
