...
export default function ReferralsListPage() {
  ...
  const markAsPaidMutation = useMutation({
    mutationFn: (id) => adminService.markReferralAsPaid(id),
    onSuccess: () => {
      queryClient.invalidateQueries(['admin-referrals']);
      queryClient.invalidateQueries(['admin-referral-stats']);
      toast.success('Recompensa marcada como paga');
    },
    onError: () => {
      toast.error('Erro ao marcar recompensa como paga');
    }
  });
        ...
        <Card className="hover:shadow-md transition-shadow rounded-xl">
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-sm text-gray-500">Total de Indicações</div>
